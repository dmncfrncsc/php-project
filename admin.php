...
?>
    ...
    <table class="booking-form" id='booktable'>
                ...
                <input type="hidden" name="id" id="id">
                    ...
                    <tr>
                        <td colspan class="table-data"><span class="subtext">ADDRESS:</span></td> 
                    ...
                    <tr>
                        <td><input type="submit" value="ADD" class="btnAdd" name="btnAdd"></td>
                        <td><input type="submit" value="UPDATE" class="btnUpdate" name="btnUpdate"></td>
                        <td><input type="submit" value="DELETE" class="btnDelete" name="btnDelete"></td>
                    </tr>
      ...
      for(var i =0; i <table.rows.length;i++){
        table.rows[i].onclick = function(){
            ...
            document.getElementById("contact").value=this.cells[4].innerHTML;
             document.getElementById("roomclass").value=this.cells[5].innerHTML;
